                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ url('admin/classEdit/' . $item->id) }}"><i
                                                class="fa-regular btn btn-info fa-pen-to-square"></i></a></td>

                                    <td><a href="{{ url('admin/classDelete/' . $item->id) }}"><i
