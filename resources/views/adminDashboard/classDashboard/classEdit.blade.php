    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('admin/classEditPost/' . $class->id ) }}" method="POST">
                @csrf
                <div class="form-group">
                  <label for="exampleInputEmail1">Name</label>
                  <input type="text" name="name" value="{{ $class->class_name}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Your Name">
                </div>
                {{--  <div class="form-group">
                    ...
                    <select class="form-select" aria-label="Default select example" name="subjectType">
                        <option selected>{{ $class->subject_type }}</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select" aria-label="Default select example" name="status">
                        <option selected>{{ $class->status }}</option>
